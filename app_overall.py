...
MQTT_TOPIC_Face       = "MakerBase/shinjia/AttendInfo"
...
def on_message(client, userdata, msg):
    if (msg.topic == MQTT_TOPIC_Face):
        ...
        mp_show = x["type"] + ", " + id_str + ", " + x["ename"]
        mp_send = "@" + x["type"] + id_str
        print("TOPIC: [" + msg.topic + "], MESSAGE: " + mp_show + "]")

        ser.flushInput() #flush input buffer
        ser.flushOutput() #flush output buffer        
        ser.write(str.encode(mp_send))
